...
class BottlesGameGroupViewPagerAdapter : PagerAdapter {
...
//        this.recyclerViews = recyclerViews
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        var view: View =
            inflater.inflate(R.layout.pager_cell_bottles_game_group, container, false)
        ...
        rootView = view
        if (position == 0) {
            view.pager_cell_bottles_game_group_match_constraint.visibility = View.VISIBLE
            handleMatches()
        } else if (position == 1) {
            view.pager_cell_bottles_game_group.visibility = View.VISIBLE
            handleGroups()
        }
    ...
    private fun handleChampionship() {
        rootView.pager_cell_bottles_game_group.visibility = View.GONE
        rootView.pager_cell_bottles_game_group_ladder_constraint.visibility = View.VISIBLE
    ...
    private fun handleMatches() {
        matchCard1 = rootView.findViewById(R.id.bottles_game_group_match_card_1)
        matchCard2 = rootView.findViewById(R.id.bottles_game_group_match_card_2)
        matchText1 = rootView.findViewById(R.id.bottles_game_group_match_text_1)
        matchText2 = rootView.findViewById(R.id.bottles_game_group_match_text_2)
    ...
    private fun attachViews() {
        card411 = rootView.findViewById(R.id.bottles_game_group_4_1_1_card)
        card412 = rootView.findViewById(R.id.bottles_game_group_4_1_2_card)
        card413 = rootView.findViewById(R.id.bottles_game_group_4_1_3_card)
        card414 = rootView.findViewById(R.id.bottles_game_group_4_1_4_card)
        card421 = rootView.findViewById(R.id.bottles_game_group_4_2_1_card)
        card422 = rootView.findViewById(R.id.bottles_game_group_4_2_2_card)
        card4win = rootView.findViewById(R.id.bottles_game_group_4_win_card)
        text411 = rootView.findViewById(R.id.bottles_game_group_4_1_1_text)
        text412 = rootView.findViewById(R.id.bottles_game_group_4_1_2_text)
        text413 = rootView.findViewById(R.id.bottles_game_group_4_1_3_text)
        text414 = rootView.findViewById(R.id.bottles_game_group_4_1_4_text)
        text421 = rootView.findViewById(R.id.bottles_game_group_4_2_1_text)
        text422 = rootView.findViewById(R.id.bottles_game_group_4_2_2_text)
        text4win = rootView.findViewById(R.id.bottles_game_group_4_win_text)

        cardMatch1 = rootView.findViewById(R.id.bottles_game_group_match_card_1)
        cardMatch2 = rootView.findViewById(R.id.bottles_game_group_match_card_2)
        textMatch1 = rootView.findViewById(R.id.bottles_game_group_match_text_1)
        textMatch2 = rootView.findViewById(R.id.bottles_game_group_match_text_2)

        groupLayout11 = rootView.findViewById(R.id.bottles_game_group_1_1_layout)
        groupLayout12 = rootView.findViewById(R.id.bottles_game_group_1_2_layout)
        groupLayout13 = rootView.findViewById(R.id.bottles_game_group_1_3_layout)
        groupLayout14 = rootView.findViewById(R.id.bottles_game_group_1_4_layout)
        groupLayout21 = rootView.findViewById(R.id.bottles_game_group_2_1_layout)
        groupLayout22 = rootView.findViewById(R.id.bottles_game_group_2_2_layout)
        groupLayout23 = rootView.findViewById(R.id.bottles_game_group_2_3_layout)
        groupLayout24 = rootView.findViewById(R.id.bottles_game_group_2_4_layout)

        groupText11 = rootView.findViewById(R.id.bottles_game_group_1_1_text)
        groupText12 = rootView.findViewById(R.id.bottles_game_group_1_2_text)
        groupText13 = rootView.findViewById(R.id.bottles_game_group_1_3_text)
        groupText14 = rootView.findViewById(R.id.bottles_game_group_1_4_text)
        groupText21 = rootView.findViewById(R.id.bottles_game_group_2_1_text)
        groupText22 = rootView.findViewById(R.id.bottles_game_group_2_2_text)
        groupText23 = rootView.findViewById(R.id.bottles_game_group_2_3_text)
        groupText24 = rootView.findViewById(R.id.bottles_game_group_2_4_text)
    }
}