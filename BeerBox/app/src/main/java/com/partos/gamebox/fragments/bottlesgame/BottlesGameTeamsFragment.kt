...
import com.partos.gamebox.recycler.BottlesGameTeamsRecyclerViewAdapter
 ...
 */
class BottlesGameTeamsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_bottles_game_teams, container, false);
        initFragment()
        return rootView
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() =
            BottlesGameTeamsFragment().apply {
    ...
    private fun initFragment() {
        ...
        recyclerView.adapter = BottlesGameTeamsRecyclerViewAdapter(teamsList)
...
//                    teamsList.add(nameEditText.text.toString())
        ...
        playButton.setOnClickListener {
            if (db.getTeamsList().size >= 2) {
                ...
                val fragment = BottlesGameLadderChoiceFragment.newInstance(teams)
                fragmentManager
                    ?.beginTransaction()
                    ?.setCustomAnimations(
                    ...
                    ?.addToBackStack(BottlesGameLadderChoiceFragment.toString())
                    ?.commit()
            } else {
                Toast.makeText(
                    rootView.context,
    ...
    private fun attachViews() {
        addButton = rootView.findViewById(R.id.bottles_game_teams_button_add)
        nameEditText = rootView.findViewById(R.id.bottles_game_teams_edit_add)
        teamsTextView = rootView.findViewById(R.id.bottles_game_teams_text_teams)
        playButton = rootView.findViewById(R.id.bottles_game_teams_button_start)
        recyclerView = rootView.findViewById(R.id.bottles_game_teams_recycler_teams)
