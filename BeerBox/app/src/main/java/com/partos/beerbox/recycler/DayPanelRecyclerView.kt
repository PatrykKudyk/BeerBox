...
class DayPanelRecyclerView(val playersList: ArrayList<String>) :
    ...
    override fun onBindViewHolder(holder: DayPanelViewHolder, position: Int) {
        holder.view.row_mafia_role_text.text = playersList[position]
        holder.view.row_mafia_role_card.setOnClickListener {
            if (holder.view.row_mafia_role_card.cardBackgroundColor == holder.view.context.getColorStateList(
                ...
                holder.view.row_mafia_role_edit.setBackgroundColor(holder.view.context.getColor(R.color.colorOrangeDark))
                ...
                holder.view.row_mafia_role_edit.setBackgroundColor(holder.view.context.getColor(R.color.colorOrangeLightLight))
